...
- [Play or download the current single-target Full YOLO workflow](evidence/pi-agent-harness/full-yolo-workflow.webm)
- [View the completed Full YOLO workflow frame](evidence/pi-agent-harness/full-yolo-workflow-poster.png)
- [Inspect the reproducible single-target workflow source](evidence/pi-agent-harness/full-yolo-workflow-walkthrough.html)
- [Inspect the machine-readable workflow and contract evidence](evidence/pi-agent-harness/full-yolo-workflow-result.json)
- [Play or download the current parallel parent/worker terminal workflow](evidence/pi-agent-harness/soher-terminal-workflow.webm)
- [View the parallel terminal workflow frame](evidence/pi-agent-harness/soher-terminal-workflow-poster.png)
- [Inspect the reproducible parallel terminal source](evidence/pi-agent-harness/soher-terminal-workflow-walkthrough.html)
